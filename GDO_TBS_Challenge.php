...
final class GDO_TBS_Challenge extends GDO
{
    public function gdoColumns()
    {
        return [
            ...
            GDT_Virtual::make('chall_solver_count')->gdtType(GDT_Decimal::make()->tooltip('tbs_tt_chall_solver_count'))->subquery("SELECT COUNT(1) FROM gdo_tbs_challengesolved cs JOIN gdo_tbs_challenge c ON c.chall_id=cs.cs_challenge WHERE cs_challenge=chall_id"),
